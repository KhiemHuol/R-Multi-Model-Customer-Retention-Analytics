...
Here is the complete, formatted code for your GitHub README.md. It combines your technical workflow with the specific performance metrics you provided.

Markdown
# ChurnScope: Multi-Model Customer Retention Analytics

## 📊 Project Overview
This project develops an end-to-end machine learning pipeline to identify high-risk customers within a telecommunications dataset. By leveraging demographic data, account information, and service usage patterns, the project compares three distinct modeling approaches to determine the most effective method for predicting customer churn.

## 🛠️ Tech Stack
* **Language:** R (RMarkdown)
* **Key Libraries:** * `tidyverse`: Data manipulation and visualization.
    * `caret`: Training and cross-validation framework.
    * `recipes`: Feature engineering and preprocessing.
    * `xgboost` & `randomForest`: Advanced ensemble modeling.
    * `pROC`: Model evaluation and AUC metrics.
